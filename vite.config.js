/**
 * The Greenville Social - Vite Configuration
 *
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
         ...
         */
        name: 'The Greenville Social - Mountain Community Lifestyle',
         ...
         */
        description: 'Your guide to Greenville\'s mountain community lifestyle - dining, outdoor adventures, and local connections',

        // ===== VISUAL BRANDING =====
        /**
         * Theme Color
         * Brand color shown in browser UI and splash screens
         * Uses forest green (#2F5233) from The Greenville Social brand palette
         */
        theme_color: '#2F5233',
