/**
 * The Hills Guide - Vite Configuration
 *
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
         ...
         */
        name: 'The Hills Guide - Luxury Lifestyle',
         ...
         */
        description: 'Curated luxury lifestyle guide for discerning residents - exclusive dining, events, and premium services',

        // ===== VISUAL BRANDING =====
        /**
         * Theme Color
         * Brand color shown in browser UI and splash screens
         * Uses luxury gold (#D4AF37) from The Hills Guide brand palette
         */
        theme_color: '#D4AF37',
