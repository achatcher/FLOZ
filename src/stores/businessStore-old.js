...
export const useBusinessStore = defineStore('business', {
  ...
  actions: {
    ...
    async fetchBusinessesLegacy() {
      ...
      return [
        // ===== FINE DINING - REAL GREENVILLE ESTABLISHMENTS =====
        {
          id: 1,
        ...
        // ===== COCKTAIL HOUR - REAL GREENVILLE ESTABLISHMENTS =====
        {
          id: 101,
          name: "Juniper",
          category: "Cocktail Hour",
          subcategory: "Craft Cocktail Bars",
          logo: "/images/businesses/juniper-logo.jpg",
          image: "/images/businesses/juniper.jpg",
          heroImage: "/images/businesses/juniper-hero.jpg",
          location: {
            lat: 34.8503,
            lng: -82.3985
          },
          contact: {
            phone: "(864) 232-7107",
            website: "https://juniperbar.com"
          },
          listing_tier: "signature",
          badges: ["Craft Cocktails", "Downtown", "Award-Winning"],
          price_range: "$$$",
          description: "Award-winning craft cocktail bar featuring $10 signature cocktails, $7 house wine, and house drafts & mocktails during happy hour (5:00-6:30pm).",
          features: {
            reservations: true,
            craft_cocktails: true,
            downtown: true,
            intimate_setting: true,
            full_bar: true,
            happy_hour: true
          }
        },
        {
          id: 102,
          name: "Vault and Vator",
          category: "Cocktail Hour",
          subcategory: "Speakeasies",
          logo: "/images/businesses/vault-vator-logo.jpg",
          image: "/images/businesses/vault-vator.jpg",
          location: {
            lat: 34.8498,
            lng: -82.3963
          },
          ...
          listing_tier: "signature",
          badges: ["Speakeasy", "Hidden Entrance", "$2 Off Cocktails"],
          price_range: "$$$",
          description: "Hidden speakeasy-style bar with $2 off cocktails during happy hour (5:00-7:00pm). Specializing in prohibition-era cocktails and vintage atmosphere.",
          features: {
            reservations: false,
            hidden_entrance: true,
            vintage_atmosphere: true,
            classic_cocktails: true,
            full_bar: true,
            happy_hour: true
          }
        },
        {
          ...
          name: "UP on the Roof",
          category: "Cocktail Hour",
          subcategory: "Rooftop Bars",
          logo: "/images/businesses/up-on-the-roof-logo.jpg",
          image: "/images/businesses/up-on-the-roof.jpg",
          location: {
            lat: 34.8515,
            lng: -82.3968
          },
          ...
          listing_tier: "signature",
          badges: ["Rooftop", "City Views", "$2 Off Cocktails"],
          price_range: "$$$",
          description: "Sophisticated rooftop bar with $2 off cocktails during happy hour (5:00-7:00pm) and stunning city skyline views.",
          features: {
            reservations: true,
            outdoor_seating: true,
            city_views: true,
        ...
        },
        {
          ...
          category: "Cocktail Hour",
          subcategory: "Craft Cocktail Bars",
          logo: "/images/businesses/ink-n-ivy-logo.jpg",
          image: "/images/businesses/ink-n-ivy.jpg",
          location: {
            lat: 34.8508,
            lng: -82.3972
          },
          ...
          listing_tier: "premier",
          badges: ["Craft Cocktails", "Half-Off Specials", "Creative Menu"],
          price_range: "$$",
          description: "Creative cocktail bar with 1/2 off Titos, Jack Daniels, wine & beer during happy hour (4:00-7:00pm). Known for unique drink presentations.",
          features: {
            reservations: false,
            craft_cocktails: true,
            seasonal_menu: true,
        ...
        },
        {
          ...
          logo: "/images/businesses/scoundrel-logo.jpg",
          image: "/images/businesses/scoundrel.jpg",
          location: {
            lat: 34.8492,
            lng: -82.3976
          },
          ...
          listing_tier: "premier",
          badges: ["Wine Bar", "$5 Beer", "$9 Wine"],
          price_range: "$$$",
          description: "$5 select beer, $9 select wine, $10 select cocktails & apps during happy hour (5:00-7:00pm). Sophisticated wine bar atmosphere.",
          features: {
            reservations: true,
            wine_selection: true,
            small_plates: true,
        ...
        },
        {
          ...
          name: "Society",
          category: "Cocktail Hour",
          subcategory: "Cocktail Lounges",
          logo: "/images/businesses/society-logo.jpg",
          image: "/images/businesses/society.jpg",
          location: {
            lat: 34.8485,
            lng: -82.3955
          },
          ...
          listing_tier: "premier",
          badges: ["$1 Off Beer & Wine", "$2 Off Spirits", "BOGO Apps"],
          price_range: "$$$",
          description: "$1 off beer & wine, $2 off spirits, BOGO apps during happy hour (4:00-7:00pm). Upscale lounge atmosphere.",
          features: {
            reservations: true,
            craft_cocktails: true,
            small_plates: true,
            upscale_atmosphere: true,
            full_bar: true,
            happy_hour: true
          }
        },
        {
          ...
          name: "Neat",
          category: "Cocktail Hour",
          subcategory: "Whiskey Bars",
          logo: "/images/businesses/neat-logo.jpg",
          image: "/images/businesses/neat.jpg",
          location: {
            lat: 34.8511,
            lng: -82.3981
          },
          ...
          listing_tier: "premier",
          badges: ["Whiskey Specialists", "Old Fashion", "Manhattan"],
          price_range: "$$$",
          description: "$5 wells, $6 select wine, $8 old fashion, manhattan & espresso martini during happy hour (4:00-7:00pm).",
          features: {
            reservations: true,
            whiskey_selection: true,
            classic_cocktails: true,
            upscale_atmosphere: true,
            full_bar: true,
            happy_hour: true
        ...
        },
        {
          ...
          name: "Paloma",
          category: "Cocktail Hour",
          subcategory: "Latin Cocktails",
          logo: "/images/businesses/paloma-logo.jpg",
          image: "/images/businesses/paloma.jpg",
          location: {
            lat: 34.8495,
            lng: -82.3968
          },
          ...
          listing_tier: "curated",
          badges: ["Margaritas", "Palomas", "Old Fashioned"],
          price_range: "$$",
          description: "$10 margaritas, palomas, old fashioned & cosmos during happy hour (5:00-7:00pm). Latin-inspired cocktail menu.",
          features: {
            reservations: false,
            latin_cocktails: true,
            margarita_specialists: true,
            casual_atmosphere: true,
            full_bar: true,
            happy_hour: true
          }
        },
        {
          ...
          name: "Indaco",
          category: "Cocktail Hour",
          subcategory: "Italian Wine Bars",
          logo: "/images/businesses/indaco-logo.jpg",
          image: "/images/businesses/indaco.jpg",
          location: {
            lat: 34.8502,
            lng: -82.3977
          },
          ...
          listing_tier: "curated",
          badges: ["25% Off Taps", "Italian Wine", "Negroni"],
          price_range: "$$",
          description: "25% off all taps, $5 Miller, $7 Peroni, $9 Negroni, house wine, old fashion & moscow mule with discounted apps (4:00-7:00pm).",
          features: {
            reservations: true,
            italian_wine: true,
            craft_beer: true,
        ...
        },
        {
          ...
          category: "Cocktail Hour",
          subcategory: "Wine Bars",
          logo: "/images/businesses/wine-house-logo.jpg",
          image: "/images/businesses/wine-house.jpg",
          location: {
            lat: 34.8488,
            lng: -82.3965
          },
          ...
          listing_tier: "curated",
          badges: ["Wine Specialists", "$2 Off Wine", "Wine Flights"],
          price_range: "$$",
          description: "$2 off wine glasses during happy hour (4:00-6:00pm). Extensive wine selection with knowledgeable staff.",
          features: {
            reservations: true,
            wine_selection: true,
            wine_flights: true,
        ...
        },
        {
          ...
          name: "Otto Izakaya",
          category: "Cocktail Hour",
          subcategory: "Japanese Bars",
          logo: "/images/businesses/otto-izakaya-logo.jpg",
          image: "/images/businesses/otto-izakaya.jpg",
          location: {
            lat: 34.8505,
            lng: -82.3972
          },
          ...
          listing_tier: "curated",
          badges: ["Japanese Sake", "BOGO Rolls", "$4 Wells"],
          price_range: "$$",
          description: "BOGO 1/2 off rolls, $4 wells, $5 house wines, $7 house sake with beer discounts during happy hour (4:00-7:00pm & 9pm-close).",
          features: {
            reservations: false,
            sake_selection: true,
            sushi_specials: true,
            japanese_atmosphere: true,
            full_bar: true,
            happy_hour: true
          }
        }
     ...
     * Returns categories with subcategories that match The Greenville Social business data
     */
