<template>
  <div class="category-listing-view">
    ...
    <div class="page-title-section">
      ...
      <p class="page-subtitle">Discover {{ categoryName.toLowerCase() }} in Greenville</p>
    </div>
    ...
    <div class="listing-content">
      ...
      <div v-if="heroListing" class="hero-listing">
        <div class="hero-card" @click="openBusiness(heroListing)">
          <div class="hero-image-container">
            ...
            />
            <TierBadge tier="signature" />
          </div>
          <div class="hero-info">
            <h2 class="hero-name">{{ heroListing.name }}</h2>
        ...
        <div class="featured-grid">
          ...
          >
            ...
            <div class="featured-info">
              <h4 class="featured-name">{{ business.name }}</h4>
              <p class="featured-category">{{ business.subcategory || business.category }}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div v-if="businessStore.loading" class="loading-state">
        ...
        <p class="loading-text">Getting ready to show you the best of Greenville.</p>
      </div>
...
import TierBadge from '@/components/Tiers/TierBadge.vue'
...
onMounted(async () => {
  ...
  try {
    await initializeApp()
    console.log('✅ App initialized for CategoryListingView')
  } catch (error) {
