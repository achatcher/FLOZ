 ...
 * and premium shopping destinations serving The Hills community. Features elegant design
...
// Mock luxury shopping data - in real app this would come from business store
const luxuryStores = ref([
  {
    id: 1,
...
const filteredStores = computed(() => {
  if (selectedCategory.value === 'all') {
    return luxuryStores.value
  }
  return luxuryStores.value.filter(store =>
...
onMounted(() => {
  ...
  // Initialize hero ad - get Cartier Boutique business
  const cartierBoutique = businessStore.getBusinessById(9) // Cartier Boutique ID
  if (cartierBoutique) {
    heroAd.value = {
      ...cartierBoutique,
      image: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=800&h=400&fit=crop&crop=center'
    }
  }
})
</script>
