...
onMounted(() => {
  console.log('🔍 BusinessDetailView: Loading business ID:', businessId.value)

  const foundBusiness = businessStore.getBusinessById(businessId.value)
  console.log('📋 BusinessDetailView: Business found:', foundBusiness)

  if (foundBusiness) {
    business.value = foundBusiness
  } else {
    console.error('❌ BusinessDetailView: Business not found for ID:', businessId.value)
