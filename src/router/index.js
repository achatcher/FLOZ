/**
 * The Hills Guide - Vue Router Configuration
 *
 * Defines the client-side routing structure for the luxury lifestyle directory.
...
import SpotlightsView from '@/views/SpotlightsView.vue'        // Featured business spotlights
...
const routes = [
   ...
   */
  {
    ...
    component: HomeView,
    meta: {
      title: 'The Hills Guide - Curated Luxury Lifestyle',
      description: 'Exclusive lifestyle guide for Bloomfield Hills residents',
      requiresAuth: false
    }
  },
   ...
   */
  {
    ...
    meta: {
      title: 'Category - The Hills Guide',
   ...
   */
  {
    ...
    meta: {
      title: 'Subcategory - The Hills Guide',
   ...
   */
  {
    ...
    meta: {
      title: 'Business Details - The Hills Guide',
   ...
   */
  {
    ...
    meta: {
      title: 'Contact Us - The Hills Guide',
      description: 'Get in touch with The Hills Guide team',
      requiresAuth: false
    }
  },
   ...
   */
  {
    ...
    component: ShareView,
    meta: {
      title: 'Share App - The Hills Guide',
      description: 'Share The Hills Guide with friends and family',
      requiresAuth: false
    }
  },
   ...
   */
  {
    ...
    component: MapView,
    meta: {
      title: 'Explore Map - The Hills Guide',
   ...
   */
  {
    ...
    meta: {
      title: 'Events Calendar - The Hills Guide',
   ...
   */
  {
    ...
    meta: {
      title: 'Business Spotlights - The Hills Guide',
   ...
   */
  {
    ...
    meta: {
      title: 'Cocktail Hour - The Hills Guide',
...
router.beforeEach((to, from, next) => {
  ...
  if (to.meta.title) {
    ...
    document.title = `${to.params.categoryName} - The Hills Guide`
  } else {
    document.title = 'The Hills Guide - Luxury Lifestyle Directory'
  }
